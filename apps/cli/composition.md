...
flowchart LR
  ...
  plugin_dsh_base_session_usage_report["session-usage-report<br/>@deepseek-ai/dsh-session-usage-report"]
  cfg --> plugin_dsh_base_session_usage_report
...
| `session-usage-report` | `@deepseek-ai/dsh-session-usage-report` |
